...
int main() { 
    ...
    float slats[132] = {0, 0, 11.1,11.2,38.1,38.2, 96.1, 96.2, 307.1, 307.2, 52.1, 52.2, //Btm
        ...
        79.1,79.2,116.1,116.2,13.1,13.2,76.1,76.2,17.1,17.2,125.1,125.2,61.2,303.1,//Barrel+Top
	104.1,104.2, //Barrel
        88.2, 88.1, 303.2, 61.1, 300.1, 300.2, 80.1, 80.2, 103.2, 103.1,// Top
	37.1, 37.2, //Barrel
	70.1, 70.2, 28.1, 28.2, 54.1, 54.2, 25.1, 25.2, 301.1, 301.2, 304.1, 304.2, //Barrel+Top
	...
	78.1, 78.2,// Top
	34.1, 34.2, 74.1, 90.2, 74.2, 90.1, 47.1, 167.2, 47.2, 167.1, 115.1, 46.2,// Top
	115.2, 46.1, 302.1, 302.2, 62.1, 62.2, 44.1, 44.2, 30.2, 30.1
	}; 
