...
simulate()
{
  xsim  Mercury_XU5 -key {Behavioral:sim_1:Functional:Mercury_XU5} -tclbatch cmd.tcl -protoinst "protoinst_files/bd_8825.protoinst" -protoinst "protoinst_files/Mercury_XU5.protoinst" -log simulate.log
}
